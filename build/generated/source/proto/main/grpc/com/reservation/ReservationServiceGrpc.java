...
public class ReservationServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.reservation.ReservationRequest,
      com.reservation.ReservationResponse> METHOD_CREATE_RESERVATION =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "ReservationService", "createReservation"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.reservation.ReservationRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.reservation.ReservationResponse.getDefaultInstance()));
  ...
  public static abstract class ReservationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createReservation(com.reservation.ReservationRequest request,
        io.grpc.stub.StreamObserver<com.reservation.ReservationResponse> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.reservation.ReservationRequest,
                com.reservation.ReservationResponse>(
  ...
  public static final class ReservationServiceBlockingStub extends io.grpc.stub.AbstractStub<ReservationServiceBlockingStub> {
    ...
    /**
     */
    public com.reservation.ReservationResponse createReservation(com.reservation.ReservationRequest request) {
  ...
  public static final class ReservationServiceFutureStub extends io.grpc.stub.AbstractStub<ReservationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.reservation.ReservationResponse> createReservation(
        com.reservation.ReservationRequest request) {
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public MethodHandlers(ReservationServiceImplBase serviceImpl, int methodId) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_RESERVATION:
          serviceImpl.createReservation((com.reservation.ReservationRequest) request,
              (io.grpc.stub.StreamObserver<com.reservation.ReservationResponse>) responseObserver);
          break;
        default:
